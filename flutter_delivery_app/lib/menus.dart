...
import 'package:flutter_delivery_app/model/foodItemMenus.dart';
        ...
        child: Container(
          child: ListView(
              children: <Widget>[
                FirstHalf(),
                SizedBox(height: 45),
                for(var foodItem in foodItemListMenus.foodItems)
  ...
  return Container(
    ...
    child: ListView(
      ...
      children: <Widget>[
       ...
       GestureDetector(
         onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => PizzaCategory())); 
         },
         child: CategoryListItem(
        ...
        GestureDetector(
         onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => MenusCategory())); 
         },
          child: CategoryListItem(
        ...
        GestureDetector(
         onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => GourmetCategory())); 
         },
          child: CategoryListItem(
        ...
        GestureDetector(
         onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => BevaregesCategory())); 
         },
          child: CategoryListItem(
